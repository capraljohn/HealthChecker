...
const emailer_service_1 = require("./modules/send-response-management/emailer/emailer.service");
...
exports.appBindings = new inversify_1.ContainerModule((bind) => {
    ...
    bind(types_1.TYPES.MailerService).to(emailer_service_1.MailerService);
